    ...
    <section className="bg-white px-6 py-16 md:px-12 lg:px-20 w-full">
      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
        ...
        <div className="hidden lg:flex flex-col justify-between self-stretch w-[20%] pt-2">
          <p className="text-[#0E0E0E] text-sm md:text-[18px] lg:text-[20px] tracking-[-4%] leading-[140%] uppercase font-geist">
            // About Us
          </p>
        ...
        <div className="flex flex-col w-full lg:w-[80%] justify-between">
          ...
          <div className="flex flex-col lg:flex-row gap-2 items-start">
            ...
            <div className="flex flex-col gap-6 w-full lg:w-[80%]">
              <h3 className="text-3xl md:text-4xl lg:text-[42px] font-semibold leading-[120%] tracking-[-4%] text-[#0E0E0E] font-barlow">
