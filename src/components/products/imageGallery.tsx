...
{/* desktop  */}
    <div className="py-16 md:flex-row justify-center items-start gap-3 md:px-12 lg:px-20 hidden md:flex">
...
<div className='flex flex-col gap-2'>
      ...
      <Image src={'/images/pngs/gallery2.png'} alt='rams' width={153} height={151}/>
    </div>
    <div className='flex flex-col gap-1 justify-between'>
      <Image src={'/images/pngs/gallery3.png'} alt='sheep' width={187} height={152}/>
      <Image src={'/images/pngs/gallery4.png'} alt='men' width={187} height={311}/>
    </div>
      </div>
      <div className='flex gap-2 justify-between'>
        <div className='flex flex-col gap-2 justify-between'>
          <Image src={'/images/pngs/gallery5.png'} alt='men' width={191} height={148}/>
