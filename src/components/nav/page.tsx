      ...
      <AnimatePresence>
        {isOpen && (
            <motion.div
                ...
                className="absolute top-full left-0 w-full bg-white px-6 pb-10 lg:hidden overflow-y-auto h-[42vh] min-[]: md:h-[45vh] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
            >
